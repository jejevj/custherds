<template>
    <div>
                        ...
                        <div class="main-menu__wrapper-inner">
                            <div class="main-menu__logo">
                                <div class="section-shape-1"
                                    :style="{ backgroundImage: 'url(' + sectionShape + ')' }"></div>
                            ...
                            <div class="main-menu__bottom">
                                <div class="main-menu__main-menu-box">
                                    ...
                                    <NavLinksOnePage :activeSection="activeSection" :menuItems="menuItems" @scroll-to="scrollTo" />
                                </div>
                                <div class="main-menu__search-and-btn-box">
                                    ...
                                    <div class="main-menu__btn-box">
                                        <router-link to="/contact" class="thm-btn main-menu__btn">Free Quota <span
                                                class="icon-up-right-arrow"></span> </router-link>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <transition name="sticky">
            <div v-show="isSticky" class="stricky-header stricked-menu main-menu stricky-fixed">
...
import NavLinksOnePage from './NavLinksOnePage.vue';
...
.navSidebar-button .icon-text:before {
    content: "\e919";
    font-family: 'tecture' !important;
}
</style>
