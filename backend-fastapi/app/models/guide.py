...
class Guide(Base):
    """
    Profil tambahan untuk user_type=1 (Herd Partner/Guide).
    """
    ...
    guide_certificate           = Column(String(500), nullable=True)   # URL di object storage
    guide_certificate_status    = Column(String(20), default="pending", nullable=False)  # pending/approved/rejected
