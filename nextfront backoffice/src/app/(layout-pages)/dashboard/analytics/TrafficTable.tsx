                ...
                >
                  ...
                  <TableCell className="text-right">
                    <Badge
                      className={
                        isPositive
                          ? "pointer-events-none bg-muted text-primary-700 border border-primary-200 rounded-full px-3 text-xs font-medium shadow-none"
                          : "pointer-events-none bg-primary-100 text-primary-700 border border-primary-200 rounded-full px-3 text-xs font-medium shadow-none"
                      }
                    >
                      {isPositive ? "+" : ""}
                      {row.growth}%
