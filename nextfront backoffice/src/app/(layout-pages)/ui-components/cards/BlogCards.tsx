        ...
        <div className="group rounded-2xl overflow-hidden bg-card border shadow flex flex-col">
          ...
          <div className="relative">
            <img
              ...
              alt="AI in SaaS"
              className="w-full h-48 object-cover transition-transform duration-700 group-hover:scale-110 filter grayscale"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent" />

            <span className="absolute top-4 left-4 text-xs px-3 py-1 rounded-full bg-muted border border-border">
              AI
            </span>
          </div>
          ...
          <div className="p-6 flex flex-col flex-1 space-y-4">
            ...
            <button className="group flex items-center gap-2 text-primary-500 font-medium mt-2">
              Read More
