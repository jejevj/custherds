...
export function IconCircleAlerts() {
    ...
    return (
        <div className="w-full max-w-3xl items-start gap-4 mx-auto space-y-6">
            ...
            <Alert className="shadow gap-4 flex-row flex py-4 px-4 rounded-xl flex-wrap border border-border">
                <div className="h-9 w-9 rounded-full flex items-center justify-center bg-primary/20 text-primary-500">
