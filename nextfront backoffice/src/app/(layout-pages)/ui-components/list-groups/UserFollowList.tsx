            ...
            <li className="flex items-center justify-between gap-4 p-4 hover:bg-muted/40 transition">
              <div className="flex items-center gap-4 min-w-0">
                <img
                  ...
                  alt="John Doe"
                  className="h-10 w-10 shrink-0 rounded-full object-cover filter grayscale"
                />
              ...
              <div className="flex shrink-0 gap-2">
                    <Button size="sm" className="bg-muted text-muted-forground">
                        <MessageCircle />
                    </Button>
                    <Button size="sm" className="bg-primary/10 text-primary-500">Follow</Button>
                </div>
            </li>
