    ...
    <div className="flex flex-col xl:flex-row gap-6">
      ...
      <main className="flex-1 space-y-6">
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <Input placeholder="Search the files" className="pl-10 h-10" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={name}
              className="rounded-xl border bg-muted p-6 space-y-2"
            >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={name}
                className="flex items-center justify-between rounded-xl border bg-muted p-6"
              >
        ...
        <div>
          ...
          <div className="rounded-xl border bg-muted overflow-x-auto p-4">
