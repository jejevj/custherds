...
export default function ChatBox() {
  ...
  return (
    <div className={`flex h-[600px] bg-muted border border-border rounded-xl overflow-hidden relative shadow`}>
      {/* Sidebar */}
      <div className={`absolute left-0 top-0 w-80 h-full bg-muted border-r border-border flex flex-col transform transition-transform duration-200 ease-in-out ${collapsed ? 'translate-x-0 z-50' : '-translate-x-full'} lg:relative lg:translate-x-0 lg:flex lg:z-auto`}>
        {/* Header */}
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <h6 className="font-semibold text-sm truncate mb-0">Alex Martin</h6>
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="hidden sm:block space-y-0">
                <h5 className="font-semibold text-md">Sophia Turner</h5>
        ...
        <ScrollArea className="flex-1 p-6 bg-muted/50">
          <div className="space-y-6 w-full h-88">
            {/* Received Message */}
