      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary to-primary/80 p-10 text-primary-foreground">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-3 max-w-md text-primary-foreground/90">
            Access your guide dashboard, manage tourist referrals,
            and track your cashback earnings with Custherds.
          </p>
          <ul className="mt-6 space-y-2 text-sm">
            <li>✔ Manage your active referrals</li>
            <li>✔ Track cashback &amp; commission history</li>
            <li>✔ Browse vendor listings to promote</li>
