...
export default function VendorLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res  = await fetch("https://www.custherds.com/vendor/login/doLogin", {
        method:  "POST",
            ...
            <CardHeader className="text-center pb-2">
              <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-[#c9a84c]">
                <svg className="h-7 w-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h18M3 9h18M3 15h10m4 4l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2" />
                </svg>
              </div>
              <CardTitle className="text-white text-2xl font-bold">Business Vendor</CardTitle>
              <CardDescription className="text-[#888] text-sm">
                Access your Custherds vendor dashboard
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="grid gap-5 mt-2">
                ...
                <div className="grid gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="/vendor/forgot-password" className="text-xs text-[#c9a84c] hover:underline">
                      Forgot password?
                    </a>
                  </div>
